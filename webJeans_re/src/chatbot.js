...
const apiKey = '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';
...
async function fetchAIResponse(prompt) {
    ...
    const requestOptions = {
        ...
        body: JSON.stringify({
            ...
            frequency_penalty: 1.0, // 일반적으로 나오지 않는 단어를 억제하는 정도
            presence_penalty: 1.0, // 동일한 단어나 구문이 반복되는 것을 억제하는 정도
